...
<h4 class="mb-4">Transaksi Barang Keluar</h4>
...
<form method="post" action="<?= base_url('transaksi/keluar') ?>" class="mb-4">
    <div class="row">
...
<!-- Form Pencarian -->
<form method="get" action="<?= base_url('transaksi/keluar') ?>" class="row mb-3">
    <div class="col-md-4">
...
<table class="table table-bordered table-striped">
    ...
    <tbody>
        ...
        <?php else: ?>
            <tr>
                <td colspan="3" class="text-center">Tidak ada transaksi ditemukan.</td>
            </tr>
        <?php endif; ?>
    </tbody>
</table>
